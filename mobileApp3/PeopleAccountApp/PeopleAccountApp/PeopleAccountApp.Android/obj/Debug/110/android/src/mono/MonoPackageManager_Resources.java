...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "PeopleAccountApp.Android.dll" comes first in this list. */
		"PeopleAccountApp.Android.dll",
		"PeopleAccountApp.DataContracts.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"PeopleAccountApp.dll",
		"Plugin.Media.dll",
		"RestEase.dll",
